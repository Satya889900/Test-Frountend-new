    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<Layout userName={user?.name || ""} />}>
          ...
          <Route path="/report-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/newsletter-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/brochure-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/certificate-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/agenda-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/memo-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/proposal-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/flyer-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/card-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/form-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/calendar-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/planner-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/budget-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/schedule-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
          <Route path="/checklist-builder" element={<PrivateRoute><DocumentBuilder /></PrivateRoute>} />
